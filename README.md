...
On the Mac App Store as *Corpospeak: In Your Voice*. A macOS app that listens to you continuously, rewrites what you said as Corpospeak using the
...
| `CorpSpeak/CorpSpeakStyle.swift` | The Corpospeak glossary and prompt, taken from [The Corpospeak Field Guide](https://claude.ai/code/artifact/0a819392-f474-464f-8815-0073bd7845e9). |
...
Corpospeak speaks only in your own voice, using the Personal Voice that macOS creates. Create
